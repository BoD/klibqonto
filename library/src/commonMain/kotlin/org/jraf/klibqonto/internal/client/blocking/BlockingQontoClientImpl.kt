...
import org.jraf.klibqonto.client.blocking.Result
import org.jraf.klibqonto.client.blocking.suspendRunCatching
...
//    override val attachments = this
    ...
    override fun getOrganization(onResult: (Result<Organization>) -> Unit) {
        klibQontoScope.launch {
            onResult(suspendRunCatching { qontoClient.organizations.getOrganization() })
        }
    }

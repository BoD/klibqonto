 ...
 *
 * Note: this class is a version of [Kotlin's Result](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-result/index.html),
 * simplified to make it compatible with Kotlin/Native targets.
 */
class Result<out T>(
